...
function UNSSection() {
    ...
    return (
        <div className='max-w-full h-fit flex flex-col items-center justify-start border-b-2 bg-black text-white px-4 sm:px-6 lg:px-8'>
            ...
            <div ref={visionRef} className='w-full h-auto lg:h-1/4 flex flex-col gap-4 items-center justify-center py-8 md:py-12'>
