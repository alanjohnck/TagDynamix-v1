...
function AnalyticsSection() {
    ...
    return (
        <div className='w-full h-fit px-6 pb-10 bg-white overflow-x-hidden'>
        <div className='max-w-full h-fit flex flex-col items-center justify-start rounded-b-lg bg-[#F6F5F8] text-black px-4 sm:px-6 lg:px-8 overflow-hidden'>
            {/* Video Container */}
